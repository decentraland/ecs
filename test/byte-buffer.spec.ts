...
describe('ByteBuffer tests', () => {
  it('test all types', () => {
    ...
    buf.writeInt64(BigInt('0xffffffffffffffff'))
    buf.writeUint8(0xff)
    buf.writeUint16(0xffff)
    buf.writeUint32(0xffffffff)
    buf.writeUint64(BigInt('0xffffffffffffffff'))
    ...
    expect(buf.readInt64()).toBe(BigInt(-1))
    ...
    expect(buf.readUint64()).toBe(BigInt('18446744073709551615'))
